        ...
        child: Actions(
          ...
          actions: <Type, Action<Intent>>{
            BackIntent: BackSlideAction(
                onBackSlide: () => Get.offAll(const ShortcutDemoSlide())),
          },
          child: Center(
            child: Column(
              ...
              children: const [
                Focus(
                    autofocus: true,
                    child: Text('Thank You Guys', style: TextStyles.header)),
                SizedBox(
                  height: 10,
                ),
                ...
                Text(
                    'I hope You All Are Understand if Any Question Please Let Me Know',
